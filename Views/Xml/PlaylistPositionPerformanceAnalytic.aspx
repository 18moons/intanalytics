...
<total>1</total>
 ...
 <% 
     ...
     dt.Columns.Add("PLAYLIST_POSITION", Type.GetType("System.Int64"));
...
%>
    <row id='<%=iIndex%>'>
        <cell><![CDATA[<%= item["PLAYLIST_POSITION"] %>]]></cell>
        <cell><![CDATA[<%= item["NAME"]     %>]]></cell>
