    ...
    <chart plot_type="Pie">
      <data_plot_settings enable_3d_mode="false">
        <pie_series>
          <tooltip_settings enabled="true">
            ...
            {%Name} Profiles
            Users: {%Value}
            Percent: {%YPercentOfSeries}{numDecimals: 0}%
            </format>
          </tooltip_settings>
      ...
      <data>
        ...
        <% for(int i=0;i<Model.Tables[0].Rows.Count;i++) { %>
          <point name="<%=Model.Tables[0].Rows[i]["PROFILES"] %>" y="<%=Model.Tables[0].Rows[i]["TOTAL"] %>" />
        <% } %>
        </series>
      </data>
      <chart_settings>
        ...
        <legend enabled="false" position="Bottom" align="Spread" ignore_auto_item="true" padding="15">
